...
namespace SherplexTickets.Infrastructure.Migrations
{
    ...
    [Migration("20240328134753_AddRole")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SherplexTickets.Infrastructure.Data.Models.IdentityModels.ApplicationRole", b =>
                {
            ...
            modelBuilder.Entity("SherplexTickets.Infrastructure.Data.Models.IdentityModels.ApplicationUser", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("SherplexTickets.Infrastructure.Data.Models.Mappings.MoviesMaping.MovieTheaterDailyScheduleForMovie", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                        .HasComment("The current DailyScheduleMovieTheater's Identifier");
                    ...
                    b.ToTable("MovieTheaterDailyScheduleForMovie");
            ...
            modelBuilder.Entity("SherplexTickets.Infrastructure.Data.Models.Movies.Movie", b =>
                {
                    ...
                    b.Property<string>("YoutubeTrailerUrl")
                        ...
                        .HasMaxLength(400)
                        .HasColumnType("nvarchar(400)")
                        .HasComment("The current Movie's YouTube Trailer Url");
            ...
            modelBuilder.Entity("SherplexTickets.Infrastructure.Data.Models.MovieTheaters.MovieTheater", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            ClosingTime = new DateTime(2024, 3, 28, 21, 0, 0, 0, DateTimeKind.Unspecified),
                            Contact = "029292929",
                            ...
                            Name = "Cinema City",
                            OpeningTime = new DateTime(2024, 3, 28, 13, 0, 0, 0, DateTimeKind.Unspecified),
                            TheaterManagerId = 1
                        },
                        new
                        {
            ...
            modelBuilder.Entity("SherplexTickets.Infrastructure.Data.Models.MovieTheaters.TheaterManager", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityRoleClaim<string>", b =>
                {
                    b.HasOne("SherplexTickets.Infrastructure.Data.Models.IdentityModels.ApplicationRole", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("SherplexTickets.Infrastructure.Data.Models.IdentityModels.ApplicationUser", null)
                        .WithMany()
            ...
            modelBuilder.Entity("SherplexTickets.Infrastructure.Data.Models.Movies.MovieReview", b =>
                {
                    ...
                    b.HasOne("SherplexTickets.Infrastructure.Data.Models.IdentityModels.ApplicationUser", "User")
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("SherplexTickets.Infrastructure.Data.Models.MovieTheaters.MovieTheater", b =>
                {
                    b.HasOne("SherplexTickets.Infrastructure.Data.Models.MovieTheaters.TheaterManager", "TheaterManager")
                        .WithMany("Theaters")
