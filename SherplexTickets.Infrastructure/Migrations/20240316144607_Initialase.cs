...
{
    public partial class Initialase : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    FullName = table.Column<string>(type: "nvarchar(2)", maxLength: 2, nullable: false, comment: "The current Actor's FirstName")
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false, comment: "The current Genre's Identifier")
                        .Annotation("SqlServer:Identity", "1, 1"),
                    Name = table.Column<string>(type: "nvarchar(70)", maxLength: 70, nullable: false, comment: "The current Genre's Name")
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    YearPublished = table.Column<DateTime>(type: "datetime2", nullable: false, comment: "The date on which the curent Movie was published"),
                    MovieWhatchTime = table.Column<int>(type: "int", nullable: false, comment: "The current Movie's Movie Watch Time")
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    TicketId = table.Column<int>(type: "int", nullable: false, comment: "The current Ticket's Identifier")
                        .Annotation("SqlServer:Identity", "1, 1"),
                    Price = table.Column<decimal>(type: "decimal(18,2)", nullable: false, comment: "The current Ticket's Price"),
